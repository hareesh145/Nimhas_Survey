...
import com.ganesh.nimhans.databinding.ActivitySupervisorsBinding;
...
public class SupervisorsActivity extends AppCompatActivity {
    Activity activity;
    private  ActivitySupervisorsBinding binding;
    String phoneNo, pswd;
    ...
    public void onClicklogout(View v) {
        ...
        editor.clear();
        editor.apply();
        Intent i = new Intent(SupervisorsActivity.this, LoginActivity.class);
        startActivity(i);
        finish();
    }

    public void onClickRegistration(View view) {
        Intent intent = new Intent(SupervisorsActivity.this, CreateUserActivity.class);
    ...
    public void onClickPendinglist(View v) {
        Intent intent = new Intent(SupervisorsActivity.this, PendingDataSearch.class);
        startActivity(intent);
    }
