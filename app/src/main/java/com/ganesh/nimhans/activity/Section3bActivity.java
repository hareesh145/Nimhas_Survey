...
public class Section3bActivity extends AppCompatActivity {
    ...
    public void onClickNextSection(View v) {
        if (binding.NoOfPeople.getText().toString().isEmpty() || binding.gender.getCheckedRadioButtonId() == -1 || binding.age.getText().toString().isEmpty() || binding.Name.getText().toString().isEmpty()){
